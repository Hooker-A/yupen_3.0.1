...
import com.huaop2p.yqs.module.four_set.activity.ScanedCustomerManager;
...
import com.huaop2p.yqs.module.one_home.Module.android.FinishListener;
import com.huaop2p.yqs.module.one_home.Module.android.InactivityTimer;
import com.huaop2p.yqs.module.one_home.Module.android.IntentSource;
...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback {
	...
	public void inputCusManager(View view) {
		final CustomD.Builder builder = new CustomD.Builder(CaptureActivity.this);
...
//            ToastUtils.show(MipcaActivityCapture.this, "二维码内容出错");
		...
		if (viewfinderView.getShowCom()) {
			...
			try {
				...
				ToastUtils.show(CaptureActivity.this, resultString);
				return;
			}
//			startActivityBy(res);
		} else {
	...
	private void startCusManager(String resultString) {
		Intent startTempManager = new Intent(CaptureActivity.this, ScanedCustomerManager.class);
