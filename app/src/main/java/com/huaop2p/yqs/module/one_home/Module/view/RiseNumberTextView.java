...
import com.huaop2p.yqs.module.one_home.interface_.RiseNumberBase;
    ...
    private void runFloat() {
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                if (flags) {
                    setText(DecimalFormatUitls.DecimalFormat_zro(Double.parseDouble(valueAnimator.getAnimatedValue().toString())));
                    if (valueAnimator.getAnimatedValue().toString().equalsIgnoreCase(number + "")) {
                        setText(DecimalFormatUitls.DecimalFormat_zro(Double.parseDouble(number + "")));
                    }
                } else {
                    setText(DecimalFormatUitls.DecimalFormat_zro(Double.parseDouble(valueAnimator.getAnimatedValue().toString())) );
                    if (valueAnimator.getAnimatedValue().toString().equalsIgnoreCase(number +"" )) {
