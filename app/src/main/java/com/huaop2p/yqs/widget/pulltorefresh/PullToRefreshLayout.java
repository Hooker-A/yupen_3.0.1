package com.huaop2p.yqs.widget.pulltorefresh;
...
public class PullToRefreshLayout extends RelativeLayout
{
	...
	// 释放刷新的距离
	private float refreshDist = -AutoUtils.getPercentHeightSize(100);
	// 释放加载的距离
	...
	public AnimationDrawable addFrame(String name, int count, int time) {
		pullView.clearAnimation();
		pullView.setImageDrawable(null);
...
//				pullView.setImageBitmap(resizedBitmap);
			...
			case REFRESHING:
				// 正在刷新状态
			//	pullView.startAnimation(refreshingAnimation);
			//	pullView.setVisibility(View.INVISIBLE);
				refreshStateTextView.setText(R.string.refreshing);
				pullView.setImageDrawable(frameAnim2);
				frameAnim2.start();
				break;
			...
			case DONE:
				frameAnim2.stop();
				pullView.setImageDrawable(frameAnim1);
				refreshStateTextView.clearAnimation();
				// 刷新或加载完毕，啥都不做
				break;
		}
	}
	...
	private void initView()
	{
		...
		pullView = (ImageView) refreshView.findViewById(R.id.pull_icon);
