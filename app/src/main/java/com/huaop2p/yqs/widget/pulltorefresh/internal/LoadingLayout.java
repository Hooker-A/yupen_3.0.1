...
import com.huaop2p.yqs.widget.pulltorefresh.ILoadingLayout;
...
//	protected final ProgressBar mHeaderProgress;
    ...
    public LoadingLayout(Context context, final PullToRefreshBase.Mode mode, final PullToRefreshBase.Orientation scrollDirection, TypedArray attrs) {
        ...
        if (mode == PullToRefreshBase.Mode.PULL_FROM_END) {
            LayoutInflater.from(context).inflate(R.layout.pull_to_refresh_header_vertical_up, this);
        } else {
        ...
        mInnerLayout = (ViewGroup) findViewById(R.id.fl_inner);
        	mHeaderText = (TextView) mInnerLayout.findViewById(R.id.pull_to_refresh_progress);
