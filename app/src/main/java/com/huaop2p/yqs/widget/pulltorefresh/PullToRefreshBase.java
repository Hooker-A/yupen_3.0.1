...
import com.huaop2p.yqs.widget.pulltorefresh.internal.LoadingLayout;
import com.huaop2p.yqs.widget.pulltorefresh.internal.RotateLoadingLayout;
import com.huaop2p.yqs.widget.pulltorefresh.internal.TweenAnimLoadingLayout;
import com.huaop2p.yqs.widget.pulltorefresh.internal.UpLoadingLayout;
import com.huaop2p.yqs.widget.pulltorefresh.internal.ViewCompat;
    ...
    public static enum AnimationStyle {
        ...
        LoadingLayout createLoadingLayout(Context context, Mode mode, Orientation scrollDirection, TypedArray attrs) {
            if (mode == Mode.PULL_FROM_END) {
                return new UpLoadingLayout(context, mode, scrollDirection, attrs);
            } else {
                switch (this) {
                    case ROTATE:
                    default:
