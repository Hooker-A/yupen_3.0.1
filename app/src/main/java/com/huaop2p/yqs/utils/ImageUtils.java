...
public class ImageUtils {
     ...
     * @return //     * @see ImageUtils#getInputStreamFromUrl(String, int, boolean)
     */
...
//            HttpUtils.setURLConnection(requestProperties, con);
     ...
     * @param imageUrl
     * @param readTimeOutMillis
     * @return //     * @see ImageUtils#getDrawableFromUrl(String, int, boolean)
     */
     ...
     * @param imageUrl
     * @param readTimeOut
     * @return //     * @see ImageUtils#getBitmapFromUrl(String, int, boolean)
     */
...
//        Log.e("scaleImage",scaleWidth+"---"+scaleHeight+"");
